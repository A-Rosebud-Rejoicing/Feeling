<?php
/**
 * A Rosebud Rejoicing functions and definitions.
 *
...
if ( ! function_exists( 'a_rosebud_rejoicing_setup' ) ) :
/**
 ...
 */
function a_rosebud_rejoicing_setup() {
	/*
	...
	add_theme_support( 'custom-background', apply_filters( 'a_rosebud_rejoicing_custom_background_args', array(
...
add_action( 'after_setup_theme', 'a_rosebud_rejoicing_setup' );
 ...
 */
function a_rosebud_rejoicing_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'a_rosebud_rejoicing_content_width', 640 );
}
add_action( 'after_setup_theme', 'a_rosebud_rejoicing_content_width', 0 );
...
add_action( 'widgets_init', 'a_rosebud_rejoicing_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'a_rosebud_rejoicing_scripts' );
